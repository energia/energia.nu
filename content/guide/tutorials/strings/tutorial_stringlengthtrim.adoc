...
You can get the length of a http://energia.nu/StringObject.html[String] using the `length()` command, or eliminate extra characters using the `trim()` command. This example shows you how to use both commands.
