...
>> link:./sidekick_blink/[Example 00: Blinking LED] (Output)

>> link:./sidekick_fadergbled/[Example 01: Fade RGB LED] (PWM)

>> link:./sidekick_pushbutton/[Example 02: Push Button] (Input)

>> link:./sidekick_blinkmultiple/[Example 03: Multiple LED] (Many Outputs)

>> link:./sidekick_shiftregister/[Example 04: Shift Register] (Integrated Circuit)

>> link:./sidekick_piezobuzzer/[Example 05: Piezo Buzzer] (Sound)

>> link:./sidekick_potentiometer/[Example 06: Potentiometer] (Variable Resistor)

>> link:./sidekick_photoresistor/[Example 07: Photoresistor] (Light Sensor)

>> link:./sidekick_spinmotor/[Example 08: Spin the Motor] (Transistor)

>> link:./sidekick_switchvoltage/[Example 08B: Switching Voltage] (Transistor)

>> link:./sidekick_temperature/[Example 09: Temperature] (Thermistor and Temp Sensor)

>> link:./sidekick_sevensegmentdisplay/[Example 10: 7 Segment Display] (Digital Display)
...
>> link:./sidekick_shiftregister2/[Example: Shift Register 2] (IC and Display)

>> link:./sidekick_shiftregister3/[Example: Shift Register 3] (IC)

>> link:./sidekick_shiftregister4/[Example: Shift Register 4] (Shift In IC)

>> link:./sidekick_spinmotor2/[Example: Spin the Motor 2] (Motor Driver)

>> link:./sidekick_spinservo/[Example: Spin the Servo] (Servo)

>> link:./sidekick_dac/[Example: DAC] (Digital to Analog IC)

>> link:./sidekick_555timer/[Example: 555 Timer] (IC and Switch)
