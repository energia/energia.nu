...
An if statement allows you to choose between two discrete options, `TRUE` or `FALSE`. When there are more than two options, you can use multiple if statements, or you can use the http://energia.nu/SwitchCase.html[*switch*] statement. Switch allows you to choose between several discrete options. This tutorial shows you how to use it to switch between four desired states of a photo resistor: really dark, dim, medium, and bright.
