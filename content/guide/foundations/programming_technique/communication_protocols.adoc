...
To use SPI in Energia, use the link:/guide/libraries/spi/[SPI library]. To use I2C in Energia, use the link:/guide/libraries/wire/[Wire library]. To use UART in Energia, use the link:/reference/en/language/functions/communication/serial/[Serial library].
