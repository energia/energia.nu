...
This function is part of the Stream class, and is called by any class that inherits from it (Wire, Serial, etc). See the link:/reference/en/language/functions/communication/stream/[Stream class] main page for more informatio
[%hardbreaks]
