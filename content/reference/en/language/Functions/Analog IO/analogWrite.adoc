...
[role="language"]
*  link:../../zero-due-mkr-family/analogwriteresolution[analogWriteResolution()]

[role="definition"]
* #DEFINITION# link:/guide/foundations/micro/tutorial_pwm[PWM^]

[role="example"]
* #EXAMPLE# link:/guide/tutorials/basics/tutorial_blink[Blink^]
